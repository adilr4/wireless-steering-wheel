...
void initSPI1(uint16_t prescaler) {  /// init SPI1 in master mode
...
uint8_t rxByteSPI1(void) {  ///  receive data using SPI1
  uint8_t data;
...
uint8_t txByteSPI1(uint8_t data) {  /// send data using SPI1
  uint8_t tmp;
